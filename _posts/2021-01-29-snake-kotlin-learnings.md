...
Finally we had to make it possible to modify said _State_ and redraw the graphics by some kind of set timer. This is done through using a timer and could be called a _Game Loop_. It is integral to have the application running and needs to run until the game is shut down.
